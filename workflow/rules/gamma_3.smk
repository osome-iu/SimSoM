...
RES_DIR = os.path.join(ABS_PATH,'results', 'short', f'02062023_{exp_type}__{sim_num}runs')
TRACKING_DIR = os.path.join(ABS_PATH,'results', 'verbose', f'02062023_{exp_type}__{sim_num}runs')
