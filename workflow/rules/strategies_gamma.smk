...
RES_DIR = os.path.join(ABS_PATH,'results', 'short', f'strategies_{exp_type}_{sim_num}runs')
TRACKING_DIR = os.path.join(ABS_PATH,'results', 'verbose', f'strategies_{exp_type}_{sim_num}runs')
