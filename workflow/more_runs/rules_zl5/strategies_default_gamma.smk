...
exp_type = "vary_gamma"
GAMMA='2' #index of default gamma (0.01)
...
RES_DIR = os.path.join(ABS_PATH,'results', f'strategies_default_5runs_')
TRACKING_DIR = os.path.join(ABS_PATH,'results_verbose', f'strategies_default_5runs_')
