...
RES_DIR = os.path.join(ABS_PATH,'results', 'cascade_scaling_')
TRACKING_DIR = os.path.join(ABS_PATH,'results_verbose', 'cascade_scaling_')
CASCADE_DIR = os.path.join(ABS_PATH,'results_cascade', 'cascade_scaling_')
