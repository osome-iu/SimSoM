...
class SimSom:
    def __init__(
        ...
        self.model_name = f"SimSomV4.7 (synchronous - permutate agent order); message 4.0;  normalized (en * no_shares); no age reset"
    ...
    def _rank_newsfeed(self, newsfeed):
        ...
        ranking = engagement * shares / np.sum(engagement * shares)
