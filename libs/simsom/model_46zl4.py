...
class SimSom:
    def __init__(
        ...
        self.model_name = f"SimSomV4.6zl4 (synchronous - permutate agent order); Message4l4 (expon quality, linear appeal exp=5);  normalized (recency * en * no_shares); no age reset"
