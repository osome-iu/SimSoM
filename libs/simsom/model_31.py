...
class SimSom:
    def __init__(
        ...
        self.model_name = (
            "SimSom 3.1 (same as 3.0 but chunking agents for simulation_step)"
        )
    ...
    def simulation(self, reshare_fpath=""):
        ...
        while self.quality_diff > self.epsilon:
            ...
            idx_groups = chunks(order, self.n_agents // 100)
            agent_groups = [
    ...
    def simulation_step(self, agent_group):
        ...
        Inputs:
            - agent_group (list of Graph vertex): list of activated agent ids
        """
