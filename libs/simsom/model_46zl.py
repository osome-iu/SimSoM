...
from simsom.message_4l import Message4l
...
class SimSom:
    def __init__(
        ...
        self.model_name = f"SimSomV4.6zl (synchronous - permutate agent order); Message4l (expon quality, linear appeal);  normalized (recency * en * no_shares); no age reset"
