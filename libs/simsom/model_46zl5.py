...
from simsom.message_4l5 import Message4l5
...
class SimSom:
    def __init__(
        ...
        self.model_name = f"SimSomV4.6zl5 (synchronous - permutate agent order); Message4l5 (expon quality, linear appeal exp=5);  normalized (recency * en * no_shares); no age reset"
