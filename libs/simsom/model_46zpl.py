...
from simsom.message_4pl import Message4pl
...
class SimSom:
    def __init__(
        ...
        self.model_name = f"SimSomV4.6zpl (synchronous - permutate agent order); Message4pl (expon quality, powerlaw appeal);  normalized (recency * en * no_shares); no age reset"
