...
from simsom.message_46 import Message46
...
class SimSom:
    def __init__(
        ...
        self.model_name = f"SimSomV4.6.1 (synchronous - permutate agent order); message 4.6;  normalized (recency * en * no_shares); no age reset"
