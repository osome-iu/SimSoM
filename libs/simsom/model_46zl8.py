...
from simsom.message_4l8 import Message4l8
...
class SimSom:
    def __init__(
        ...
        self.model_name = f"SimSomV4.6zl8 (synchronous - permutate agent order); Message4l8 (expon quality, linear appeal exp=8);  normalized (recency * en * no_shares); no age reset"
