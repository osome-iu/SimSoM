...
from simsom.message_q10 import Messageq10
...
class SimSom:
    def __init__(
        ...
        self.model_name = f"SimSomV4.6zl (synchronous - permutate agent order); Message (expon quality, linear appeal exp={appeal_exp}, quality exp q=10);  normalized (recency * en * no_shares); no age reset"
