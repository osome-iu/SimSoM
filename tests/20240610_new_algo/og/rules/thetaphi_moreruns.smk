...
EXP_NOS = [exp for exp in EXPS.keys() if exp[0]=='0'] #theta=1
EXP2NET = {
...
RES_DIR = os.path.join(ABS_PATH,'results', 'og_algo_phi__5runs')
TRACKING_DIR = os.path.join(ABS_PATH,'results_verbose', 'og_algo_phi__5runs')
# CASCADE_DIR = os.path.join(ABS_PATH,'results_cascade', og_algo_phi)
