...
network_fpath = os.path.join(DATA_PATH, "vary_network", "network_30.gml")

# G = init_net(**net_specs)
# G.write(network_fpath, format="gml")

RESULT_DIR = "/N/u/baotruon/BigRed200/simsom/tests/20240426_quality_timestep/results"
...
exp_config = "/N/project/simsom/simsom_v3/10242023_v3.3/config/vary_phigamma/03.json"

simulation_specs = json.load(open(exp_config, "r"))
simulation_specs["converge_by"] = "steps"
simulation_specs["max_steps"] = 500
